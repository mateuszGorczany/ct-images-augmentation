...
from src.models.medical_diffusion.ddpm.text import tokenize, bert_embed, BERT_MODEL_DIM
...
class GaussianDiffusion(nn.Module):
    ...
    def forward(self, x, *args, **kwargs):
        ...
        check_shape(
            x, "b c f h w", c=self.channels, f=self.num_frames, h=img_size, w=img_size
        )
