from src.models.medical_diffusion.ddpm.time_embedding import TimeEmbbeding
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.loca_time_embedder = nn.Sequential(
            get_act_layer(name=act_name), nn.Linear(time_emb_dim, in_ch)  # in_ch * 2
        )
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.up_op = UnetUpBlock(
            spatial_dims, enc_ch, skip_ch, act_name=act_name, **kwargs
        )
        self.loca_time_embedder = nn.Sequential(
            get_act_layer(name=act_name),
...
class UNet(nn.Module):
    ...
    def forward_with_cond_scale(self, *args, cond_scale=0.0, **kwargs):
