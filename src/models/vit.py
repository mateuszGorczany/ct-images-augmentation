"""
This code is based on https://github.com/lucidrains/vit-pytorch/blob/main/vit_pytorch/vit.py
and https://github.com/FirasGit/MeTra/blob/master/classification/models/multi_modal_pretrained_vit_lab.py
"""
...
class MultiModalPretrainedViTLab(nn.Module):
    ...
    def forward(self, data):
        ...
        x = torch.cat((x_image1, x_ehr), dim=1)
